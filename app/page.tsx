        ...
        <section className="relative z-40 grid min-w-0 grid-cols-1 gap-4 lg:grid-cols-5 lg:gap-5">
          <div className="relative min-w-0 lg:col-span-3">
            <div className="relative min-w-0 overflow-visible rounded-[1.35rem] p-4 shadow-[0_40px_90px_rgba(0,0,0,0.5)] sm:rounded-[2rem] sm:p-8 lg:p-9">
              ...
              <div
                id="hero-fortune-logo"
                className="pointer-events-none absolute left-1/2 top-2 z-30 grid h-[min(42vw,160px)] w-[min(42vw,160px)] -translate-x-1/2 place-items-center opacity-95 sm:top-3 sm:h-[210px] sm:w-[210px]"
                aria-hidden
              >
                <Image
        ...
        <section id="services" className="mt-8 grid grid-cols-12 gap-6 lg:gap-8">
          <Reveal delay={0.55} className="col-span-12">
            ...
            <div className="mt-8 grid gap-5 lg:grid-cols-3">
              ...
              <article className="mu-lab-glass rounded-2xl p-7 shadow-[inset_0_1px_0_rgba(247,231,206,0.14),0_26px_52px_rgba(1,4,16,0.4)]">
