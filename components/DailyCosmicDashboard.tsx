...
export default function DailyCosmicDashboard({ data }: Props) {
  ...
  return (
    <section
      className="col-span-12 rounded-[1.35rem] border border-[rgba(247,231,206,0.45)] bg-[#0d1735]/82 p-5 shadow-[0_18px_44px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:rounded-3xl sm:p-6"
      aria-labelledby="daily-cosmic-heading"
    >
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <h2
          id="daily-cosmic-heading"
          className="font-serif text-xl font-medium tracking-tight text-[#edf3ff] sm:text-2xl"
        >
          Cosmic Weather
        </h2>
        <div className="flex flex-wrap items-center gap-2 text-sm text-[#d8e2ff]/78">
      ...
      <p className="mb-4 rounded-2xl border border-[rgba(247,231,206,0.4)] bg-[#0a1636] px-4 py-3 text-base font-light leading-relaxed text-[#d8e2ff]">
      ...
      <div className="mt-4 grid gap-3 lg:grid-cols-4">
        <article className="rounded-2xl border border-[rgba(247,231,206,0.36)] bg-[#0a1636] p-3 lg:col-span-2">
          <p className="text-xs uppercase tracking-[0.1em] text-[var(--gold)]/75">Daily Lab Note</p>
          <p className="mt-1.5 text-base font-light text-[#d8e2ff]/92">{hasLabNote ? data.labNote : emptyStateText}</p>
        </article>
        <article className="rounded-2xl border border-[rgba(247,231,206,0.36)] bg-[#0a1636] p-3">
          <p className="text-xs uppercase tracking-[0.1em] text-[var(--gold)]/75">Ritual</p>
          <p className="mt-1.5 text-base font-light text-[#d8e2ff]/92">{hasRitual ? data.ritualOfTheDay : emptyStateText}</p>
        </article>
        <article className="rounded-2xl border border-[rgba(247,231,206,0.36)] bg-[#0a1636] p-3">
          <p className="text-xs uppercase tracking-[0.1em] text-[var(--gold)]/75">Lucky</p>
          <p className="mt-1.5 text-base font-light text-[#d8e2ff]/92">
