...
export default function LoginDialog({ open, onClose, nextPath }: LoginDialogProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] grid place-items-center overflow-y-auto px-4 py-6 sm:py-10"
      role="dialog"
      aria-modal="true"
    ...
    >
      <button
        ...
        aria-label="ปิด"
        onClick={onClose}
        className="mu-lab-modal-backdrop fixed inset-0 cursor-default bg-[rgba(3,5,16,0.72)] backdrop-blur-2xl backdrop-saturate-150"
      />

      <div className="mu-lab-modal-card relative z-10 my-auto w-full max-w-md">
        <div
          aria-hidden
